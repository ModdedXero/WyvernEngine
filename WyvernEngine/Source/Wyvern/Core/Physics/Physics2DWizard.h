...
namespace Wyvern
{
	...
	private:
		...
		static Collision2D GetCollisionData(Entity entity, BoxCollider2D* collider, Entity otherEnt, BoxCollider2D* otherCollider);
		static Collision2D GetCollisionData(Entity entity, BoxCollider2D* collider, Entity otherEnt, SphereCollider2D* otherCollider);
		static Collision2D GetCollisionData(Entity entity, SphereCollider2D* collider, Entity otherEnt, BoxCollider2D* otherCollider);
	};
}