...
void PongLayer::OnAttach()
{
	...
	matb->material = AssetManager::GetMaterial("StandardMaterial");
	matb->sprite = AssetManager::GetSprite("Ball");
	matb->color = { 1,1,1,1 };
	...
	p1sMat->material = AssetManager::GetMaterial("StandardMaterial");
	...
	p2sMat->material = AssetManager::GetMaterial("StandardMaterial");
	...
	p3sMat->material = AssetManager::GetMaterial("StandardMaterial");
	...
	p4sMat->material = AssetManager::GetMaterial("StandardMaterial");
	...
	p5sMat->material = AssetManager::GetMaterial("StandardMaterial");
	...
	p6sMat->material = AssetManager::GetMaterial("StandardMaterial");
